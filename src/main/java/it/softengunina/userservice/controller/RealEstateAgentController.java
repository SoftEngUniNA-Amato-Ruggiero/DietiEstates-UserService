...
public class RealEstateAgentController {
    ...
    @PostMapping
    public RealEstateAgent createAgent(@RequestBody RealEstateAgentDTO agent) {
    ...
    @PutMapping("/{id}")
    public User updateAgent(@PathVariable Long id, @RequestBody RealEstateAgentDTO agent) {
